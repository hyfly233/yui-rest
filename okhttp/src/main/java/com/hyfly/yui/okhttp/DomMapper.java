...
public class DomMapper {
    ...
    public static <T> T readValue(final Element doc, final Class<T> clazz) {
        ...
        enhancer.setCallback(newCssQueryMethodInterceptor(clazz, doc));
    ...
    public static <T> List<T> readList(Element doc, Class<T> clazz) {
        org.springblade.core.http.CssQuery annotation = clazz.getAnnotation(org.springblade.core.http.CssQuery.class);
        if (annotation == null) {
